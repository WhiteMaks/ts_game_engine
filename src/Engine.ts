...
export class Engine extends GraphicsEngine.GraphicsApplication {
	...
	private readonly layerStack: Layer.ILayerStack<Layer.BaseLayer>;
	...
	public pushLayer(layer: Layer.BaseLayer): void {
		this.layerStack.push(layer);
	}

	public pushOverlayLayer(layer: Layer.BaseLayer): void {
